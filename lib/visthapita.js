 ...
 * @api public
 */
module.exports.create = function(dir,env,config,title, callback){
  //get driver
  var driver;
 ...
 * @api public
 */
module.exports.up = function(dir,env,config,title, callback){
  //get driver
  var driver;
  //use name
 ...
 * @api public
 */
module.exports.up_all = function(dir,env,config,callback){
  //get driver
  var driver;
 ...
 * @api public
 */
module.exports.down = function(dir, env, config, callback ){
  //get driver
  var driver;
      ...
      if(migration){
        ...
        driver.getAppliedMigrations(dir,function(db_migrations){
          ...
          //and migration table delete
            ...
            callback(
              new Error(
                'No migrations have been applied to the DB.'
              )
            );
          }
        });
        ...
        //error to callback migration file not found
        callback(new Error('No migration files found in:'+dir));
      }
    }
  });
};
